...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [mineL] = LAYOUT_moonlander(
  ...
  [mediaL] = LAYOUT_moonlander(
    ...
    _______,        RGB_HUI,        RGB_SAI,        RGB_VAI,        RGB_MOD,        _______,        _______,                                        WEBUSB_PAIR,    _______,   KC_AUDIO_VOL_DOWN,   KC_AUDIO_VOL_UP,     KC_AUDIO_MUTE,       _______,        KC_SYSTEM_POWER,
    _______,        RGB_HUD,        RGB_SAD,        RGB_VAD,        RGB_TOG,    TOGGLE_LAYER_COLOR, _______,                                        _______,        _______,   KC_MEDIA_PREV_TRACK, KC_MEDIA_PLAY_PAUSE, KC_MEDIA_NEXT_TRACK, _______,        _______,        
