...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [mineL] = LAYOUT_moonlander(
  ...
  [ja1L] = LAYOUT_moonlander(
    ...
    LCTL(KC_BSPACE),TD(DANCE_19),   KC_T,           KC_D,           KC_S,           KC_Q,           _______,                                        LGUI(KC_6),     KC_H,           KC_4,           KC_E,           KC_LBRACKET,    KC_G,           TD(DANCE_22),   
  ...
  [editL] = LAYOUT_moonlander(
    ...
    _______,        _______,        _______,        _______,        MOSL(fncKeysL), KC_INSERT,                                                                      _______,        LCTL(KC_S),     _______,        KC_RALT,        _______,        _______,        
